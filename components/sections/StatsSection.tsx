  ...
  return (
    <section className="border-y border-gold-soft bg-gold-soft/10 py-16">
      <div className="mx-auto grid max-w-7xl gap-5 px-5 sm:px-8 lg:grid-cols-3">
        {stats.map((stat) => (
          <div key={stat.number} className="rounded-lg border border-gold-soft bg-white p-8 text-center shadow-gold">
            <p className="font-heading text-5xl font-black text-gold sm:text-6xl">{stat.number}</p>
